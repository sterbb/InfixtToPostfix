...
public class InfixtoPostfix_MultipleNumbers2 {
            ...
            if (j == infixarray.size()-1){
                ...
                if(infixarray.get(j).equals("+")||infixarray.get(j).equals("-")||infixarray.get(j).equals("*")||infixarray.get(j).equals("/")||infixarray.get(j).equals("^")||infixarray.get(j).equals(")")){
                    ...
                    while(infixarray.get(j).equals("1")||infixarray.get(j).equals("2")||infixarray.get(j).equals("3")||infixarray.get(j).equals("4")||
                        ...
                        cn+=infixarray.get(j);
                        infixarray.remove(j);
                        System.out.println(infixarray+"gaano na");
                        if(infixarray.get(j).equals("+")||infixarray.get(j).equals("-")||infixarray.get(j).equals("*")||infixarray.get(j).equals("/")||infixarray.get(j).equals("^")||infixarray.get(j).equals(")")){
                            infixarray.add(j,cn);
                            System.out.println(infixarray+"diin na ni man");
                            System.out.println(cn+"sa operator ni ya");
                            cn ="";
                            System.out.println(j+"ang current");
                            break;
                            ...
                            infixarray.add(j,cn);
                            cn ="";
                            System.out.println(infixarray+"d nko tsende tol hahaha");
                            break;
                        }
                    }
                }
        ...
        while(proceed){
                if(j == infixarray.size()-1){
                    break;
                        ...
                        infixarray.get(j).equals("9")||infixarray.get(j).equals("0")||infixarray.get(j).equals("-1")||infixarray.get(j).equals("-2")||
                        infixarray.get(j).equals("-3")||infixarray.get(j).equals("-4")|| infixarray.get(j).equals("-5")||infixarray.get(j).equals("-6")||
                        infixarray.get(j).equals("-7")||infixarray.get(j).equals("-8")|| infixarray.get(j).equals("-9")||infixarray.get(j).equals("-0")||infixarray.get(j).equals(".")||infixarray.get(j).equals("-.")))
                {



                    if (infixarray.get(j).equals(".")||infixarray.get(j).equals("-.")){
                        decimal+=1;
                    }
                    cn+=infixarray.get(j);
                    ...
                    while(proceed1){
                       if (infixarray.get(j).equals("1")||infixarray.get(j).equals("2")||infixarray.get(j).equals("3")||infixarray.get(j).equals("4")||
                        ...
                        (infixarray.get(j).equals(".") && decimal <= 1)){
                           ...
                           if (infixarray.get(j).equals(".") && decimal <= 1){
                               decimal+=2;
                               cn+=infixarray.get(j);
                               infixarray.remove(infixarray.get(j));
                       ...
                       }else if(infixarray.get(j).equals("+")||infixarray.get(j).equals("-")||infixarray.get(j).equals("*")||infixarray.get(j).equals("/")||infixarray.get(j).equals(")")||infixarray.get(j).equals("^")){
                            infixarray.add(j,cn);
                            System.out.println(infixarray+"diin na ni man");
                            System.out.println(cn+"sa operator ni ya");
                            j+=1;
                ...
                }else if(infixarray.get(j).equals("(")||infixarray.get(j).equals("+")||infixarray.get(j).equals("-")||
                        infixarray.get(j).equals("*")||infixarray.get(j).equals("/")||infixarray.get(j).equals("^")){
                    j+=1;
                    System.out.println(j+"diin kna tol");
                }
        }
