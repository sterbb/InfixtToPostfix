                ...
                for (int i = 0; i < chararray.size(); i++) {
                    ...
                    // Check if the first and last element is an operator
                        ...
                        if (chararray.get(i + 1).equals('+') || chararray.get(i + 1).equals('*') || chararray.get(i + 1).equals('/') ||
                                chararray.get(i + 1).equals('-') || chararray.get(i - 1).equals('0') || chararray.get(i - 1).equals('1') || chararray.get(i - 1).equals('2') || chararray.get(i - 1).equals('3') || chararray.get(i - 1).equals('4') || chararray.get(i - 1).equals('5') ||
