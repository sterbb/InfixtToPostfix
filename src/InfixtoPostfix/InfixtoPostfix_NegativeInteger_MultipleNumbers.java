...
public class InfixtoPostfix_NegativeInteger_MultipleNumbers {
        ...
        do {
                ...
                for (int i = 0; i < chararray.size(); i++) {
                    ...
                    //check if there are equal open and close parenthesis
                        ...
                        if (chararray.get(i + 1).equals('+')||chararray.get(i + 1).equals('-')||chararray.get(i + 1).equals('*')||chararray.get(i + 1).equals('/')||chararray.get(i + 1).equals('(')||
                            ...
                            System.out.println(infixarray.get(i)+"kalong nmn utok mo tol");
                            condition = 10;
                            break;
                        }
            ...
            switch (condition) {
                ...
                case 6:
                    ...
                    System.out.println(condition+"anu cndition ta tol buhi pa?");
